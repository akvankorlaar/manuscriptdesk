...
class StylometricAnalysisRequestProcessor extends ManuscriptDeskBaseRequestProcessor{
    ...
    private function loadForm2PystylConfigurationData() {
        ...
        $config_array['minimumsize'] = (int) $validator->validateStringNumber($request->getText('wpminimumsize'));
        $config_array['maximumsize'] = (int) $validator->validateStringNumber($request->getText('wpmaximumsize'));
        $config_array['segmentsize'] = (int) $validator->validateStringNumber($request->getText('wpsegmentsize'));
        $config_array['stepsize'] = (int) $validator->validateStringNumber($request->getText('wpstepsize'));
        ...
        $config_array['minimumdf'] = floatval($validator->validateStringNumber($request->getText('wpminimumdf')));
        $config_array['maximumdf'] = floatval($validator->validateStringNumber($request->getText('wpmaximumdf')));
