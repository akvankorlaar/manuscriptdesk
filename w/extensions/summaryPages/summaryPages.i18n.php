...
$messages['en'] = array(  
  ...
  'singlemanuscriptpages-instruction'             => 'Click one of the buttons to view all manuscript pages (not belonging to a collection) starting with the letter of your choice.',
