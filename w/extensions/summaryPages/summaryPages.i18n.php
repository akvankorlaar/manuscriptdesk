...
$messages['en'] = array(  
  ...
  'allmanuscriptpages-nomanuscripts'              => 'There are no manuscript pages without collection that begin with this letter yet.',
  'allmanuscriptpages-nomanuscripts-number'       => 'There are no manuscript pages without collection that begin with this number yet.',
  ...
  'allmanuscriptpages-instruction'                => 'Click one of the buttons to view all manuscript pages (not belonging to a collection) starting with the letter of your choice.',
  ...
  'userpage-error-editmax2'                       => 'charachters for the textfields',
