...
class summaryPageWrapper{
   ...
   * @return type an array of all manuscripts
   */
  private function retrieveSingleManuscriptPages(){
  ...
  /**
   * This function retrieves from the 'alphabetnumbers' database
   */
  public function retrieveAlphabetNumbers(){
    ...
    $res = $dbr->select(
      ...
      array(
        'alphabetnumbers_context = ' . $dbr->addQuotes($request_context), //contitions
      ),
      __METHOD__
      );
