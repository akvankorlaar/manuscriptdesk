...
class SpecialAllCollections extends ManuscriptDeskBaseViewer {
    use LetterBarView;    
    
  /**
   * This function shows the page after a request has been processed
   */
  protected function showPage(array $title_array, $alphabet_numbers = array()){
   ...
   */
  protected function showSingleCollectionData($single_collection_data, $alphabet_numbers = array(), $selected_collection){
   ...
   */
  protected function showDefaultPage(array $alphabet_numbers, array $uppercase_alphabet, array $lowercase_alphabet){
